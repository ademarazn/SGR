...
public class RelatorioVendas extends javax.swing.JDialog {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(lblRazaoSocial, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblTexto, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void buscar() {
        List<Object> itemPedidos = new ItemPedidoDAO().consultarPorPeriodo(ini, fim);
        carregarTabela(itemPedidos);
    }

    public void setModeloTabela() {
        String[] colunas = {"Código", "Nome", "Quantidade", "Vl. Unitário", "Vl. Total"};
    ...
    private void carregarTabela(List<Object> itens) {
        ...
        for (Object itemObj : itens) {
            ...
            int codigo = Integer.parseInt(String.valueOf(item[0]));
            String nome = String.valueOf(item[1]);
            int quantidade = Integer.parseInt(String.valueOf(item[2]));
            float vlUnit = Float.parseFloat(String.valueOf(item[3]));
            String vlUnitario = decimalFormat.format(vlUnit);
            String vlTotal = decimalFormat.format(vlUnit * quantidade);
            Object[] linha = new Object[]{codigo, nome, quantidade, vlUnitario, vlTotal};
            modelo.addRow(linha);
        }
    }
